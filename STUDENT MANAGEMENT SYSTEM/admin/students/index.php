			...
			<div class="table-responsive">
				<table class="table table-sm table-hover table-striped table-bordered" id="list">
					...
					<tbody>
						<?php 
						$i = 1;
						$qry = $conn->query("SELECT * from `student_list` order by `name` asc ");
						...
						?>
							<tr>
								...
								<td class="align-items-center">
									<div><span class="text-muted"><?= $row['regno'] ?></span> - <?= $row['name'] ?></div>
								</td>
								<td class="align-items-center"><p class="mb-0 truncate-1"><?= $row['email'] ?></p></td>
								...
								<td class="align-items-center" align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item" href="./?page=students/view_student&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item" href="./?page=students/manage_student&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
										<div class="dropdown-divider"></div>
